...
export default function CatallaxDashboard() {
  useSeoMeta({
    title: 'Catallax - Decentralized Contract Work',
    description: 'A decentralized platform for contract work with escrow arbitration on Nostr',
  });
                ...
                {arbitersLoading ? (
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto">
                    {arbiters.map((arbiter) => (
                      <ArbiterCard key={arbiter.id} arbiter={arbiter} />
                    ))}
                  </div>
                ) : (
                  <div className="text-center py-8">
